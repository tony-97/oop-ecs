...
public:
    ...
    template<class T, class U> constexpr reference<T>       operator[](U u) { return GetRequiredContainer<T>()[u]; }
    template<class T, class U> constexpr const_reference<T> operator[](U u) const { return GetRequiredContainer<T>()[u]; }

    template<class T, class U> constexpr reference<T>       at(U u)       { return GetRequiredContainer<T>().at(u); }
    template<class T, class U> constexpr const_reference<T> at(U u) const { return GetRequiredContainer<T>().at(u); }
